...
<header class="header_area">
    ...
    <div class="div">
        <div class="div-1">
            ...
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border-radius: 4px;">全部</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;">0-6个月</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;">6个月-2岁</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;">2-5岁</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;">5岁+</button></a>


            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border-radius: 4px;">全部</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;" >0-2kg</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"> <button class="div-1-1 btn" style="border: none;">2kg-5kg</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"> <button class="div-1-1 btn" style="border: none;">5kg-10kg</button></a>
            <a href="${pageContext.request.contextPath}/jsp/Pet_Show.jsp" target="myframe"><button class="div-1-1 btn" style="border: none;">10kg+</button></a>
