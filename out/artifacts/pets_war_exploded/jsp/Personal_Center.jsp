    ...
    <div class="div-1-1">
        <div class="div-1">
            ...
            <div class="div-4">
                ...
                <div class="div-4-1">昵称：<input type="text" value="${user.number}" style="border: none;background-color:#F2F2F2;height: 20px; "></div>
                <div class="div-4-1">邮箱：<input type="text" value="${user.email}" style="border: none;background-color:#F2F2F2;height: 20px; "></div>
            </div>
            ...
            <div class="div-5">
                ...
                <div class="div-5-1">收养状态：未收养</div>
